...
#     resp = input("This directory already exists. \
#                  If you continue, the contents of the existing directory will be deleted. \
#                  If you would still like to proceed, enter [Y]. Otherwise, enter [N]: ")
#   if resp == "Y": 
#     shutil.rmtree(root)
#   else:
#     exit()
...
def on_click(x, y, button, pressed):
  ...
  if pressed:
    ...
    if not eyes is None:
      # Save the image
      print(f"save image x: {x}, y: {y}")
      filename = root + "{}_{}_{}.jpeg".format(x, y, button)
